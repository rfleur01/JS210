...
// The problem was that one pencil remained in the shopping cart, although we intended to update the quantity 
// of pencils to 0 on line 70. The reason is the following: When we call updateCart on line 70, 
// the amount passed in is 0. Since 0 is treated as falsy in JavaScript, amount || 1 (line 21) returns 1. 
// So every time we want to set the amount of some item to 0, it is set to 1 instead.