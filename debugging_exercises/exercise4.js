...
// After removing the logical not operator (!) and replacing the relevant && with the logical or operator (||), 
// one test case still fails. The reason is that we need to use parentheses to be explicit about the order in 
